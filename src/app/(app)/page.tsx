  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900 text-gray-100">
      ...
      <section ref={heroRef} className="relative py-20 md:pb-32 md:pt-24">
        <AnimateOnScroll variant="reveal-up" threshold={0.2}>
              ...
              {[
                ...
                >
                  <div className="relative h-full rounded-xl bg-gray-900 p-8">
                    ...
                    {index < 2 && (
                      <div
                        className={`absolute -bottom-4 rotate-90 left-1/2 md:rotate-0 md:left-auto md:bottom-auto md:-right-4 md:top-1/2 h-[3px] opacity-0 w-8 bg-gradient-to-r from-transparent to-purple-600 block fade-in-left`}
                        style={{
      ...
      <section id="features" className="py-24">
        <AnimateOnScroll variant="slide-up" threshold={0.2}>
          <div className="container mx-auto px-6">
            <div className="mb-16 text-center">
              <div className="mb-3 inline-block rounded-full bg-purple-900/30 px-4 py-1 text-sm font-medium text-purple-300 backdrop-blur-sm">
                Powerful Tools
      ...
      <footer className="border-t border-gray-800 bg-gray-950 py-12">
        <AnimateOnScroll variant="fade-in" threshold={0.1}>
          <div className="container mx-auto px-6">
            <div>
              <div>
